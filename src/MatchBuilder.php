...
class MatchBuilder
{
     ...
     * @return $this
     */
    public function match($keywords = null): static
    {
        if ($keywords !== null) {
     ...
     * @return $this
     */
    public function orMatch($keywords = null): static
    {
     ...
     * @return $this
     */
    public function maybe($keywords = null): static
    {
     ...
     * @return $this
     */
    public function not($keyword = null): static
    {
        $this->tokens[] = array('OPERATOR' => '-');
        $this->match($keyword);
     ...
     * @return $this
     */
    public function field($fields, $limit = null): static
    {
        if (is_string($fields)) {
     ...
     * @return $this
     */
    public function ignoreField($fields): static
    {
        if (is_string($fields)) {
            $fields = func_get_args();
        }
     ...
     * @return $this
     */
    public function phrase(string $keywords): static
    {
     ...
     * @return $this
     */
    public function orPhrase(string $keywords): static
    {
        $this->tokens[] = array('OPERATOR' => '| ');
     ...
     * @return $this
     */
    public function proximity(string $keywords, int $distance): static
    {
        $this->tokens[] = array(
            'PROXIMITY' => $distance,
            'keywords' => $keywords,
     ...
     * @return $this
     */
    public function quorum(string $keywords, $threshold): static
    {
        $this->tokens[] = array(
            'QUORUM' => $threshold,
            'keywords' => $keywords,
     ...
     * @return $this
     */
    public function before($keywords = null): static
    {
        $this->tokens[] = array('OPERATOR' => '<< ');
        $this->match($keywords);
     ...
     * @return $this
     */
    public function exact($keyword = null): static
    {
        $this->tokens[] = array('OPERATOR' => '=');
        $this->match($keyword);
     ...
     * @return $this
     */
    public function boost($keyword, $amount = null): static
    {
        if ($amount === null) {
            $amount = $keyword;
        } else {
     ...
     * @return $this
     */
    public function near($keywords, $distance = null): static
    {
     ...
     * @return $this
     */
    public function sentence($keywords = null): static
    {
     ...
     * @return $this
     */
    public function paragraph($keywords = null): static
    {
     ...
     * @return $this
     */
    public function zone($zones, $keywords = null): static
    {
        if (is_string($zones)) {
            $zones = array($zones);
        }
     ...
     * @return $this
     */
    public function zonespan(string $zone, $keywords = null): static
    {
    ...
    public function compile(): static
    {
        ...
        foreach ($this->tokens as $token) {
            if (key($token) == 'MATCH') {
                ...
                } elseif (!str_contains($token['MATCH'], ' ')) {
